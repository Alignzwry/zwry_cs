...
// 2024-05-10 00:16:57.129526600 UTC
    ...
    namespace schemas {
        ...
        namespace client_dll {
            ...
            namespace C_PointClientUIHUD {
                ...
                constexpr std::ptrdiff_t m_unOwnerContext = 0xEA8; // 
                constexpr std::ptrdiff_t m_unHorizontalAlign = 0xEAC; // 
                constexpr std::ptrdiff_t m_unVerticalAlign = 0xEB0; // 
                constexpr std::ptrdiff_t m_unOrientation = 0xEB4; // 
            ...
            namespace C_LightGlow {
                constexpr std::ptrdiff_t m_nHorizontalSize = 0xCD0; // 
                constexpr std::ptrdiff_t m_nVerticalSize = 0xCD4; // 
                constexpr std::ptrdiff_t m_nMinDist = 0xCD8; // 
                constexpr std::ptrdiff_t m_nMaxDist = 0xCDC; // 
                constexpr std::ptrdiff_t m_nOuterMaxDist = 0xCE0; // 
            ...
            namespace C_CSTeam {
                ...
                constexpr std::ptrdiff_t m_iClanID = 0x8A0; // 
            ...
            namespace C_CSPlayerPawn {
                ...
                constexpr std::ptrdiff_t m_unPreviousWeaponHash = 0x14C8; // 
                constexpr std::ptrdiff_t m_unWeaponHash = 0x14CC; // 
            ...
            namespace C_RagdollPropAttached {
                constexpr std::ptrdiff_t m_boneIndexAttached = 0xF50; // 
                constexpr std::ptrdiff_t m_ragdollAttachedObjectIndex = 0xF54; // 
            ...
            namespace C_CSGOViewModel {
                ...
                constexpr std::ptrdiff_t m_nWeaponParity = 0xF74; // 
                constexpr std::ptrdiff_t m_nOldWeaponParity = 0xF78; // 
            ...
            namespace C_EntityDissolve {
                ...
                constexpr std::ptrdiff_t m_nMagnitude = 0xD08; // 
            ...
            namespace C_BaseFire {
                ...
                constexpr std::ptrdiff_t m_nFlags = 0x55C; // 
            }
            // Parent: C_BaseEntity
            // Fields count: 15
            //
            ...
            namespace CBasePlayerController {
                ...
                constexpr std::ptrdiff_t m_nTickBase = 0x600; // 
                ...
                constexpr std::ptrdiff_t m_iDesiredFOV = 0x6CC; // 
            }
            // Parent: C_BaseCSGrenadeProjectile
            // Fields count: 3
            //
            ...
            namespace C_BasePlayerPawn {
                ...
                constexpr std::ptrdiff_t m_nHighestConsumedServerViewAngleChangeIndex = 0x11A0; // 
                constexpr std::ptrdiff_t v_angle = 0x11A4; // QAngle
                constexpr std::ptrdiff_t v_anglePrevious = 0x11B0; // QAngle
                constexpr std::ptrdiff_t m_iHideHUD = 0x11BC; // 
            ...
            namespace C_EconEntity {
                ...
                constexpr std::ptrdiff_t m_OriginalOwnerXuidLow = 0x1540; // 
                constexpr std::ptrdiff_t m_OriginalOwnerXuidHigh = 0x1544; // 
            ...
            namespace C_EnvDecal {
                ...
                constexpr std::ptrdiff_t m_nRenderOrder = 0xCE4; // 
            ...
            namespace C_PlayerSprayDecal {
                ...
                constexpr std::ptrdiff_t m_unAccountID = 0xCD4; // 
                constexpr std::ptrdiff_t m_unTraceID = 0xCD8; // 
                constexpr std::ptrdiff_t m_rtGcTime = 0xCDC; // 
            ...
            namespace C_BaseFlex {
                ...
                constexpr std::ptrdiff_t m_nNextSceneEventId = 0xF88; // 
            ...
            namespace C_CSWeaponBase {
                ...
                constexpr std::ptrdiff_t m_smokeAttachments = 0x1844; // 
            ...
            namespace C_BaseEntity {
                ...
                constexpr std::ptrdiff_t m_spawnflags = 0x3CC; // 
                ...
                constexpr std::ptrdiff_t m_fEffects = 0x434; // 
            ...
            namespace C_Beam {
                ...
                constexpr std::ptrdiff_t m_nBeamFlags = 0xD1C; // 
            ...
            namespace CCSPlayerController {
                ...
                constexpr std::ptrdiff_t m_iPing = 0x718; // 
                ...
                constexpr std::ptrdiff_t m_unPlayerTvControlFlags = 0x78C; // 
                constexpr std::ptrdiff_t m_iDraftIndex = 0x7B8; // int32
                constexpr std::ptrdiff_t m_msQueuedModeDisconnectionTimestamp = 0x7BC; // 
                constexpr std::ptrdiff_t m_uiAbandonRecordedReason = 0x7C0; // 
            ...
            namespace CInfoWorldLayer {
                ...
                constexpr std::ptrdiff_t m_hLayerSpawnGroup = 0x58C; // 
            ...
            namespace C_BaseViewModel {
                ...
                constexpr std::ptrdiff_t m_nViewModelIndex = 0xEEC; // 
                constexpr std::ptrdiff_t m_nAnimationParity = 0xEF0; // 
            ...
            namespace C_Sprite {
                ...
                constexpr std::ptrdiff_t m_nBrightness = 0xD10; // 
            ...
            namespace C_Chicken {
                ...
                constexpr std::ptrdiff_t m_OriginalOwnerXuidLow = 0x1600; // 
                constexpr std::ptrdiff_t m_OriginalOwnerXuidHigh = 0x1604; // 
